...
\begin{itemize}
    ...
    \item oprogramowanie jest kompatybilne z trzema najpopularniejszymi systemami operacyjnymi w Polsce, na dzień przygotowywania tej pracy % TODO: źródło o wykorzystaniu systemów
...
Oprogramowanie, którego dotyczy ta praca, pełni rolę pośrednika między przedsiębiorcą/pracownikiem a Krajowym Systemem e-Faktur. Jego główną rolą jest przyjęcie faktur w wybrany przez użytkownika sposób, przekonwertowanie ich do formatu akcepotwanego przez KSeF, wysyłka oraz upewnienie się, że proces został wykonany bez żadnych nieprawidłowości - lub poinformowanie użytkownika o działaniach wymaganych do poprawnego wykonania procesu.
\\
\\
...
\begin{itemize}
    ...
    \item \enquote{kolejka} lokalna, do przechowywania danych w przypadku przerwania komunikacji z internetem/braku dostępności 
